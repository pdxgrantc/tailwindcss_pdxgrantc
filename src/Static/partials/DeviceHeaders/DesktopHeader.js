...
export default function DesktopHeader({ header_title }) {
    ...
    if (header_title === "About This Site") {
    ...
    return (
        <div class="flex justify-between">
            <Link class="w-[35vw] bg-black pl-[5vw] text-[3.75rem] font-bold leading-[5.75rem] h-[12vh] hover:cursor-pointer mobile:text-4xl" to={title_link}>{header_title}</Link>
