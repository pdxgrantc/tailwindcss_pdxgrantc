    ...
    return (
        <>
            <div class="m-auto bg-main_bg_color text-text_white">
                <Header />
                <div class="relative on_mobile:mb-10vh on_mobile:mt-[2vh] on_mobile:flex on_mobile:gap-[5vh] on_mobile:flex-col on_mobile:w-[90vw] on_mobile:m-auto on_mobile:h-[95vh]">
                    ...
                    <div class="max-w-[43vw] pl-[2vw] absolute right-[5vw] bottom-[40vh] on_mobile on_mobile:max-w-none on_mobile:p-0 on_mobile:static on_mobile:w-[100%]">
                        ...
                        <h3 class="text-[3.5rem] font-semibold on_mobile:text-[2rem]">Full Stack Web Developer</h3>
                        <h3 class="text-[3.5rem] font-semibold text-text_grey on_mobile:text-[2rem]">Student at Oregon State University</h3>
                    </div>
                </div>
